...
class EnigmaTest < Minitest::Test
  ...
  # def test_it_can_crack_a_message_with_a_date
  #   expected = {decryption: "hello world end", key: "02715", date: "030201"}
  #
  #   assert_equal expected, @enigma.crack("jibaqdmdtpupgru", "030201")
  # end
end
